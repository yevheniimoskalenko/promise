const YevheniiPromise = require('./promise')
...
describe('Vladilen Promise: ', () => {
  ...
  beforeEach(() => {
    ...
    promise = new YevheniiPromise(executorSpy)
  })

  test('should exists and to be typeof function', () => {
    expect(YevheniiPromise).toBeDefined()
    expect(typeof YevheniiPromise).toBe('function')
  })
